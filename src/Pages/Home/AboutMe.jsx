      ...
      <div className="hero--section--content--box about--section--box">
        <div className="hero--section--content">
          ...
          I am a Software Engineer with a background in both traditional education from Moringa School
           ...
           Limax, and Impact Outsourcing AI. While proficient in software engineering, I am also eager to 
           explore the intersection of machine learning with my current expertise. Known for my adaptability,
            diligence, and problem-solving abilities, I am committed to delivering innovative solutions in the tech industry.
